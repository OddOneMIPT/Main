...
import random
test = ( A([random.random() for _ in range(4)],[1,2,0,0]),
B([random.random() for _ in range(4)],[1,2,0,0]),
C([random.random() for _ in range(4)],[1,2,0,0]))
for i in test:
    print(i, i.get_answer(), i.get_loss())
